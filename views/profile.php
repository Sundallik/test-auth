...
<div class="mx-auto w-25 bg-white p-4 mt-5 border rounded">
    ...
    <form action="<?=ROOT?>/profile/update" method="post">
        <div class="form-group">
            <label for="exampleInputEmail1">Имя</label>
            <input name="name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Имя" value="<?=$user['name']?>">
        ...
        <div class="form-group mt-2">
            ...
            <input name="phone" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Телефон" value="<?=$user['phone']?>">
        ...
        <div class="text-center">
            ...
            <a href="<?=ROOT?>/profile/logout" class="d-block">Выход</a>
        </div>
